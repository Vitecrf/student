...
public class AccountManagmentController {
	...
	@PostMapping
	UserProfileDto register(@RequestBody UserRegDto userRegDto) {
	...
	@PutMapping
	public UserProfileDto updateUser(@PathVariable String login, @RequestBody UserUpdateDto useUpdateDto) {
		return accountService.updateUser(login, useUpdateDto);
	}
