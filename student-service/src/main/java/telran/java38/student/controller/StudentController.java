...
public class StudentController {
	...
	public StudentDto findStudent(@PathVariable Integer id) {			//@PathVariable  - переменная пути
	...
	@PutMapping("/studetn/{id}")
	public StudentBaseDto updateStudent(@PathVariable Integer id, @RequestBody StudentUpdateDto studentUpdateDto, @RequestHeader("Authorization") String token) {
		System.out.println(token);
		return studentService.updateStudent(id, studentUpdateDto);
	}
	
	@PutMapping("/score/studetn/{id}")
	...
	public List<StudentDto> findStudentByParams(@PathVariable String group, @PathVariable String name){
	...
	public List<StudentDto> findStudentByExamScore(@PathVariable String exam, @PathVariable Integer score){
